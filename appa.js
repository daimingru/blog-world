...
app.get('/index',function(req,res){
    ...
    var url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf114c69f6437bf60&redirect_uri='+return_uri+'&response_type=code&state=aa_bb_cc&scope=snsapi_userinfo&state=#wechat_redirect';
    res.redirect(url);
